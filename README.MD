...
```
Pipe.py reformats the gwas_sumstats into -o altered_gwas_file.txt for processing, the altered file is located in GWAS_alt folder, named by the output file. DO NOT PUT ".gz" IN THE OUTPUT.<br />
